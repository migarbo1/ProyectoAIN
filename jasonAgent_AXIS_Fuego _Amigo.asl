...
+!get_agent_to_aim
    <-
        ...
        if (Length > 0) {
            ...
            +bucle(0);
            -+aimed("false");
            while(aimed("false") & bucle(X) & X < Length) { //MIENTRAS NO HAYA OBSERVADO TODOS LOS AGENTES Y NO ESTE A PUNTANDO A NADIE
				// Object structure 
                ...
                //NADA
                    ...
                    if (Team == 100) {  // SI ENCUENTRA UN ENEMIGO
                        ...
                        //DEBUG
						while(aimed("true") & bubucle(J) & J < X) { // RECORRE LOS OBJETOS QUE ESTAN DELANTE DE EL
                            //DEBUG
							...
							//NADA 
								...
								if (Teamm == 200){ // SI HAY UN ALIADO DELANTE
									...
									if((D+DistA) >= (DistE) & (D+DistA) <= (DistE+5)){//SI LA SUMA DE DISTANCIA ES PARECIDA A LA DISTANCIA ENTRE EL AGENTE Y EL ENEMIGO ESTA EN MEDIO DE LA LINEA DE FUEGO
										-+aimed("false");
